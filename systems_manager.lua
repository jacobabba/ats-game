do
    ...
    --This is handy if you want to remove the entity from the manager.
    function systemManager.getEntities(entityManagers)
        local entities = {}
        local indexToManagerId = {}
        local n = 1
        for k,v in ipairs(entityManagers) do
            local e = v:getEntsFromSig({"transform", "motion"})
